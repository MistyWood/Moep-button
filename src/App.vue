            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                    <ul class="nav navbar-nav">
                        <!-- <li><a href="" target="_blank"><img src="resources/youtube_social_icon_red.png" height="18"/></a></li> -->
                        <li><a href="https://twitter.com/k_moeka_" target="_blank"><img src="resources/Twitter_Social_Icon_Circle_Color.png" height="18"/></a></li>
                    </ul>
        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <div class="pull-right">
                    <div class="text-right"><a href="https://github.com/MistyWood/Moep-button" target="_blank">{{$t("info.toGithub")}} <img src="https://img.shields.io/github/stars/MistyWood/Moep-button.svg?style=social"/></a></div>
                    <div class="text-right">{{$t("info.notOfficial")}}</div>
                </div>
                <div>{{$t("info.audioStaff")}}</div>
                <div>shihou 2021-2022 <span style="color: rgba(0, 0, 0, 0.1)">Powered By Meowsound Idols</span></div>
            </div>
        </footer>
  </div>
</template>
